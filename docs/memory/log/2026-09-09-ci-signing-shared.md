...
- **Superseded in part**: the nightly's guarded set narrowed and it now syncs its inputs rather than refusing. Why: [2026-09-10](2026-09-10-nightly-input-sync.md).
